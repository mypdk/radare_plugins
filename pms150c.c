...
"0000.0000.101i.iiii", "mov a,io", 2, "", "a = io; if (io == 0) z = 0; cycle(1);",
"0000.0000.100i.iiii", "mov io,a", 2, "", "io = a; cycle(1);",
"0001.0111.cccc.cccc", "mov a,c", 2, "", "a = c; cycle(1);",
"0000.0111.11MM.MMMM", "mov a,M", 2, "", "a = memory[M]; if (io == 0) z = 0; cycle(1);"
"0000.0101.11MM.MMMM", "mov M,a", 2, "", "memory[M] = a; cycle(1);",
"0000.0000.110M.MMM1", "ldt16 M", 1, "", "memory[M] = timer16; cycle(1);",
"0000.0000.110M.MMM0", "stt16 M", 1, "", "timer16 = memory[M]; cycle(1);",
"0000.0000.111M.MMM1", "idxm a,M", 2, "", "a = memory[M]; cycle(2);",
"0000.0000.111M.MMM0", "idxm M,a", 2, "", "memory[M] = a; cycle(2);",
"0000.1001.11MM.MMMM", "xch M", 1, "", "temp = a; a = memory[M]; memory[M] = a; cycle(1);",
"0000.0000.0011.0010", "pushaf", 0, "", "memory[sp] = a; sp = sp + 1; memory[sp] = flags; sp = sp + 1; cycle(1);",
"0000.0000.0011.0011", "popaf", 0, "", "sp = sp - 1; flags = memory[sp]; sp = sp - 1; a = memory[sp]; cycle(1);",
"0001.0000.cccc.cccc", "add a,c", 2, "", "a = a + c; all_flags(); cycle(1);",
"0000.0110.00MM.MMMM", "add a,M", 2, "", "a = a + memory[M]; all_flags(); cycle(1);",
"0000.0100.00MM.MMMM", "add M,a", 2, "", "memory[M] = a + memory[M]; all_flags(); cycle(1);",
"0000.0000.0001.0000", "addc a", 1, "", "a = a + cf; all_flags(); cycle(1);",
"0000.0110.10MM.MMMM", "addc a,M", 2, "", "a = a + cf + memory[M]; all_flags(); cycle(1);",
"0000.0100.10MM.MMMM", "addc M,a", 2, "", "memory[M] = a + cf + memory[M]; all_flags(); cycle(1);",
"0001.0001.cccc.cccc", "sub a,c", 2, "", "a = a - c; all_flags(); cycle(1);",
"0000.0110.01MM.MMMM", "sub a,M", 2, "", "a = a - memory[M]; all_flags(); cycle(1);",
"0000.0100.01MM.MMMM", "sub M,a", 2, "", "memory[M] = a - memory[M]; all_flags(); cycle(1);",
"0000.0000.0001.0001", "subc a", 2, "", "a = a - cf; all_flags(); cycle(1);",
"0000.0110.11MM.MMMM", "subc a,M", 2, "", "a = a - cf - memory[M]; all_flags(); cycle(1);",
"0000.0100.11MM.MMMM", "subc M,a", 2, "", "memory[M] = a - cf - memory[M]; all_flags(); cycle(1);",
"0000.1001.00MM.MMMM", "inc M", 1, "", "memory[M] = memory[M] + 1; all_flags(); cycle(1);",
"0000.1001.01MM.MMMM", "dec M", 1, "", "memory[M] = memory[M] - 1; all_flags(); cycle(1);",
"0000.1001.10MM.MMMM", "clear M", 1, "", "memory[M] = 0; cycle(1);",
"0000.0000.0001.1010", "sr a", 1, "", "a = a >> 1; cf; cycle(1);",
"0000.1010.10MM.MMMM", "sr M", 1, "", "memory[M] = memory[M] >> 1; cf; cycle(1);",
"0000.0000.0001.1100", "src a", 1, "", "memory[M] = cf << 8 + memory[M] >> 1; cf; cycle(1);",
